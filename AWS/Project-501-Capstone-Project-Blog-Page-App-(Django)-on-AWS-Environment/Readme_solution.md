# Project-501 : Blog Page Application (Django) deployed on AWS Application Load Balancer with Auto Scaling, S3, Relational Database Service(RDS), VPC's Components, DynamoDB and Cloudfront with Route 53 (STUDENT_SOLUTION)
...
def lambda_handler(event, context):
    ...
    if event:
        ...
        dynamoTable = dynamo_db.Table('awscapstoneDynamo') # this is important name / Whatever name was given before, the same should be written.
