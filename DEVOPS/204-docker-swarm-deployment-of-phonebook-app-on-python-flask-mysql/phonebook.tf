...
provider "aws" {
  ...
  //  access_key = ""
  //  secret_key = ""
  //  If you have entered your credentials in AWS CLI before, you do not need to use these arguments. But if you use credentials you must be carefull and dont push them to the github etc.
}
