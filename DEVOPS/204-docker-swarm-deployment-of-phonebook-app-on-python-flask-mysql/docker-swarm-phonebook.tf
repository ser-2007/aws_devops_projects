...
locals {
  github-repo = "https://github.com/ser-2007/https://github.com/ser-2007/aws_devops_projects/tree/main/DEVOPS/204-docker-swarm-deployment-of-phonebook-app-on-python-flask-mysql.git"
  github-file-url = "https://raw.githubusercontent.com/ser-2007/https://github.com/ser-2007/aws_devops_projects/tree/main/DEVOPS/204-docker-swarm-deployment-of-phonebook-app-on-python-flask-mysql/main/"
}
...
resource "aws_security_group" "tf-docker-sec-gr1" {
  name = "docker-swarm-sec-gr1"
  tags = {
    Name = "swarm-sec-gr"
  }
  dynamic "ingress" {
